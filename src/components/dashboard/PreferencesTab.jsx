...
export default function PreferencesTab() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-serif italic text-3xl text-white">Account Preferences</h1>
        <p className="text-white/60 mt-1">Customize your shopping experience.</p>
      </div>
      ...
      <div className="bg-surface/50 backdrop-blur-md border border-line/60 rounded-3xl p-6 md:p-8 space-y-8">
        ...
        {/* Theme Settings */}
        <div>
          <h2 className="text-xl font-serif italic text-white mb-6">Display Settings</h2>
          <div className="flex items-center justify-between p-4 bg-secondary/30 rounded-xl border border-line/30">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/50 text-sm">Toggle between light and dark theme.</p>
              </div>
            </div>
        ...
        {/* Regional Settings */}
        <div>
          <h2 className="text-xl font-serif italic text-white mb-6">Regional Settings</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-white/70 text-sm font-medium flex items-center gap-2">
                <FiGlobe /> Language
              </label>
              <select className="w-full bg-secondary/30 border border-line/50 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary/50 appearance-none">
