    ...
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-ink/60 mt-1">Products you've looked at recently.</p>
        </div>
      </div>
      ...
      {user.recentlyViewed.length > 0 ? (
        ...
        <div className="bg-surface/50 backdrop-blur-md border border-line/60 rounded-3xl p-12 text-center">
          ...
          <h3 className="text-xl text-ink font-serif italic mb-2">No recently viewed items</h3>
          <p className="text-ink/50 max-w-md mx-auto mb-6">You haven't browsed any products recently.</p>
