...
export default function Features() {
  return <section className="bg-section" style={{
    paddingBlock: "clamp(36px, 5vw, 64px)"
  }}>
      <Container className="flex flex-col gap-8 md:gap-10">
        <SectionTitle eyebrow={"Why Luxora"} title={"The Smarter Way to Shop"} description="We've built a premium shopping experience around what matters most to you." />
...
return <motion.div initial={{
    ...
    delay: index * 0.09,
    ease
  }} className="group bg-surface flex flex-col" style={{
    borderRadius: 24,
    ...
    e.currentTarget.style.boxShadow = "0 0 0 1px rgba(124,58,237,.10), 0 4px 10px rgba(20,16,18,.04), 0 24px 56px -16px rgba(124,58,237,.14)";
  }} onMouseLeave={e => {
    ...
    e.currentTarget.style.boxShadow = "0 0 0 1px rgba(20,16,18,.038), 0 1px 3px rgba(20,16,18,.026), 0 8px 22px -12px rgba(20,16,18,.07)";
      ...
      <h3 className="font-semibold text-ink mb-2" style={{
      fontSize: 16,
      letterSpacing: "-0.005em"
    }}>
        {title}
      </h3>
      <p className="text-muted font-light flex-1" style={{
      fontSize: 13,
      lineHeight: 1.82
    }}>
        {description}
