...
export default function ShopProductGrid({ products, viewMode, onQuickView }) {
  if (products.length === 0) {
    return (
      <div className="py-24 text-center">
        ...
        <h3 className="text-3xl text-ink font-serif italic mb-3">No Products Found</h3>
        <p className="text-ink/60 max-w-md mx-auto text-lg">
          We couldn't find anything matching your current filters. Try adjusting your search or clearing filters to see more results.
        </p>
      </div>
    );
  }
  ...
  const getGridClass = () => {
    switch (viewMode) {
      case "compact": return "grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4";
