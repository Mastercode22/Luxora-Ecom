    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      ...
      <div className="relative w-full md:w-96">
        ...
        <input 
          ...
          className="w-full bg-surface border border-line/60 rounded-xl pl-12 pr-4 py-3.5 text-ink placeholder:text-ink/40 focus:outline-none focus:border-primary/50 transition-colors shadow-sm"
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button 
          ...
          className="lg:hidden flex items-center justify-center gap-2 px-4 py-3.5 bg-surface border border-line/60 rounded-xl text-ink font-medium"
        >
        ...
        <div className="hidden sm:flex items-center p-1 bg-surface border border-line/60 rounded-xl">
          <button 
            ...
            className={`p-2.5 rounded-lg transition-colors ${viewMode === 'grid' ? 'bg-secondary text-ink shadow-sm' : 'text-ink/40 hover:text-ink'}`}
            title="Grid View"
          >
            <FiGrid size={20} />
          </button>
          <button 
            ...
            className={`p-2.5 rounded-lg transition-colors ${viewMode === 'list' ? 'bg-secondary text-ink shadow-sm' : 'text-ink/40 hover:text-ink'}`}
            title="List View"
          >
            <FiList size={20} />
          </button>
        ...
        <div className="relative" ref={sortRef}>
          <button 
            ...
            className="flex items-center justify-between gap-3 w-48 px-4 py-3.5 bg-surface border border-line/60 rounded-xl text-ink font-medium hover:border-primary/50 transition-colors shadow-sm"
          >
